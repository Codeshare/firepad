...
firepad.Firepad = (function(global) {
  ...
  function Firepad(ref, place, options) {
    ...
    if (global.CodeMirror && place instanceof global.CodeMirror) {
      ...
      this.codeMirror_ = this.editor_ = new global.CodeMirror(place);
    }
    ...
    if (this.getOption('richTextShortcuts', false)) {
      if (!global.CodeMirror.keyMap['richtext']) {
  ...
  Firepad.prototype.initializeKeyMap_ = function() {
    ...
    global.CodeMirror.keyMap["richtext"] = {
